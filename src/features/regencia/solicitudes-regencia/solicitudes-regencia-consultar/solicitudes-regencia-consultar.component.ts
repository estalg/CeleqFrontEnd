...
@Component({
  selector: 'app-solicitudes-regencia-consultar',
  templateUrl: './solicitudes-regencia-consultar.component.html',
  styleUrls: ['./solicitudes-regencia-consultar.component.css']
})
export class SolicitudesRegenciaConsultarComponent implements OnInit {
  ...
  marcarReactivos() {
    // tslint:disable-next-line:prefer-for-of
    for (let i = 0; i < this.dataSourceReactivos.data.length; i++) {
      if (this.dataSourceReactivos.data[i].estadoEnSolicitud === 'Aceptado') {
  ...
  marcarCristaleria() {
    // tslint:disable-next-line:prefer-for-of
    for (let i = 0; i < this.dataSourceCristaleria.data.length; i++) {
      if (this.dataSourceCristaleria.data[i].estadoEnSolicitud === 'Aceptado') {
